...
void pfalgo3_full_ref(TkObj track[NTRACK], MuObj mu[NMU], PFChargedObj outmu[NMU]) ;
...
void mp7wrapped_pack_out(PFChargedObj outmu[NMU], MP7DataWord data[MP7_NCHANN]) ;
void mp7wrapped_unpack_out(MP7DataWord data[MP7_NCHANN], PFChargedObj outmu[NMU]) ;
...
#define PFALGO3_DR2MAX_TK_MU   0.04
