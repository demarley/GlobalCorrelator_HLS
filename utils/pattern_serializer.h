...
class HumanReadablePatternSerializer {
    public:
        ...
        void operator()(const TkObj track[NTRACK], const MuObj mu[NMU], const PFChargedObj outch[NTRACK], const PFChargedObj outmu[NMU]) ;
        void dump_inputs(const TkObj track[NTRACK], const MuObj mu[NMU]) ;
...
//        void dump_outputs(const PFChargedObj outch[NTRACK], const PFNeutralObj outpho[NPHOTON], const PFNeutralObj outne[NSELCALO], const PFChargedObj outmu[NMU]) ;
        void dump_outputs(const PFChargedObj outch[NTRACK], const PFChargedObj outmu[NMU]) ;
